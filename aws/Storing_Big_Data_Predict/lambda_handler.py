...
def lambda_handler(event, context):
    ...
    __TableName__ = 'DEGEOWAM-streaming-dynamodb' # <-- Insert your table name
    # Configure Firehose service as part of Step 6
    firehose_name = 'degeowam-deliverystream' # <-- Insert your Firehose name
    # Set up logging
    ...
    table = dynamodb.Table(__TableName__) # <-- Write code to update the value of this variable.
